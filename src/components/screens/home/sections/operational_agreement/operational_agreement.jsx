      ...
      <CustomContainer>
        <div className={styles.head}>
          <h2 data-aos="fade-right">
            Operational Agreement & Performance Policy
          </h2>
          <p data-aos="fade-left">
            To maintain transparency and professional standards, an MOU will be
            executed after mutual KYC verification.
          </p>
        </div>
